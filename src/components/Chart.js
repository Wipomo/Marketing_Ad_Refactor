...
class Chart extends React.Component {
  ...
  render() {
    ...
    const { Baseline, Economy, Compact, Intermediate, Standard, Premium, Selected_EVPV, EV_Rate_Charging} = this.props.chartData;
    ...
    system_type_payback.push(EV_Rate_Charging.payback);
    ...
    const options = {
      ...
      series: [{
        ...
        name: loanDataNeeded ? "Plug In EV (Loan Payback "+ EV_Rate_Charging.loan_payback.toPrecision(2) +" Years)" : "Plug In EV (Payback "+ EV_Rate_Charging.payback.toPrecision(2) +" Years)",
        data: loanDataNeeded ? EV_Rate_Charging.loanData : EV_Rate_Charging.data,
        dashStyle: 'shortdot',
        visible: system_type_payback.includes(EV_Rate_Charging.payback),
        marker: {
          symbol: "triangle",
          radius: 5
        },
