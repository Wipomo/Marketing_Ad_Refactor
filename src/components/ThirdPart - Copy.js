        ...
        <div className='App'>
          <div className='main3'>
            <div className='m3Upper'>
              <p className='medium'>Thank you! <br></br><br></br>Check for a confirmation email in your Inbox or SPAM folder; add us to your Contacts to receive a personalized <a href="https://www.makello.com/energy-analysis.html">Energy Analysis</a> from Makello</p>
        ...
        <div className='App'>
          <div className='main3'>
            <div className='row m3Upper text-center pd20-top'>
              <p className='regular regular-fontSize full-width pd20-top'>Thank you!<br></br> <br></br> Check for a confirmation email in your Inbox or SPAM folder; add us to your Contacts to receive a personalized <a href="https://www.makello.com/energy-analysis.html">Energy Analysis</a> from <a href="https://www.makello.com/">Makello</a>!</p>
            </div>
            ...
            <div className='m3Lower text-center'>
              <a href="http://www.makello.com">www.makello.com</a>
              <p className="semiBold italic-font">"Make it low, with Makello!"</p>
              <p>
